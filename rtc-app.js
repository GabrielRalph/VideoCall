...
class VideoPannel extends SvgPlus {
  ...
  muteRemote(){
    let remote = this.videos.remote;
    let mute = !this.remote_muted;
    this.remote_muted = mute;
    remote.video.mute = mute;
    remote.setIcon("topLeft", mute ? "unmute" : "mute", () => this.muteRemote());
  }
